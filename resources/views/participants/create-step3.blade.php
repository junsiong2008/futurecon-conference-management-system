...
<div class="container">
    <div class="progress">
        <div class="progress-bar" role="progressbar" aria-valuenow="66.67" aria-valuemin="0" aria-valuemax="100"
            style="width:66.67%">
    ...
    <div class="card border-0 shadow my-5">
        <div class="card-body p-5">
            <h1 class="font-weight-light">Payment Information</h1>
            ...
            <form action="/participants/store" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                        <input id="not_paid" name="payment_status" type="radio" value="0"
                            class="payment_radio custom-control-input" required>
                        <label class="custom-control-label" for="not_paid">On-site payment</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input id="paid" name="payment_status" type="radio" value="1"
                            class="payment_radio custom-control-input" required>
